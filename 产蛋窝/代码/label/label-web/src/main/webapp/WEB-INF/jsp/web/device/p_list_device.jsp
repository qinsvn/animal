						...
						<div class="row m-l m-b m-t">
							<div class="form-group">
								...
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="search_device_num" type="text" class="input-sm form-control">
								</div>
								<label>厂房  ：</label>
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="search_work_shop_name" type="text" class="input-sm form-control">
								</div>
							</div>
						</div>
						<div class="row m-l m-b">
							<div class=" m-b-xs">
								...
								<shiro:hasPermission name="label:bsWorkshop:create">
									<button class="btn btn-sm btn-info" id="addDeviceButt">新增设备</button>
								</shiro:hasPermission>
								<shiro:hasPermission name="label:bsWorkshop:delete">
									<button class="btn btn-sm btn-info" id="deleteDeviceButt">删除设备</button>
								</shiro:hasPermission>
							</div>
						</div>
  ...
  <!--  新增 -->
	<div class="modal fade in" id="create_win">
	    <div class="modal-dialog">
	        <div class="modal-content" style="width: 700px;height: 420px;overflow: auto;">
	            <div class="modal-body wrapper-lg">
	                <div class="row">
	                    <section class="panel panel-default" style=" margin-bottom: 40px;">
	                        <header class="panel-heading font-bold" >新增设备</header>
	                        <div class="panel-body">
	                            <form class="bs-example form-horizontal" autocomplete="off">
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label">设备编号<span class="red-color">*</span></label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_domain" id="add_device_num" placeholder="设备编号">
	                                    </div>
	                                </div>
	                                
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group">
	                                	<label class="col-sm-2 control-label">所属厂房<span class="red-color">*</span></label>
	                                	<div class="col-sm-10">
		                                	<select id="add_workshopId" class="form-control">
												<option value="-1" >请选择厂房</option>
											</select>
	                                	</div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_domain" id="add_device_name" placeholder="填写备注">
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
...
<!--  编辑 -->
	<div class="modal fade in" id="edit_win">
	    <div class="modal-dialog">
	        <div class="modal-content" style="width: 700px;height: 420px;overflow: auto;">
	            <div class="modal-body wrapper-lg">
	                <div class="row">
	                    <section class="panel panel-default" style=" margin-bottom: 40px;">
	                        <header class="panel-heading font-bold" >编辑设备</header>
	                        <div class="panel-body">
	                            <form class="bs-example form-horizontal" autocomplete="off">
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label ">设备编号<span class="red-color">*</span></label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_name" id="edit_device_num" placeholder="设备编号，不可重复">
	                                ...
	                                <div class="form-group">
	                                	<label class="col-sm-2 control-label">所属厂房<span class="red-color">*</span></label>
	                                	<div class="col-sm-10">
		                                	<select id="edit_workshopId" class="form-control">
												<option value="-1" >请选择厂房</option>
											</select>
	                                	</div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label">备注</label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_domain" id="edit_device_name" placeholder="备注">
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group" style="margin-bottom: 0">
		...
		<script src="${basePath}/resources/js/web/device/p_list_device.js"></script>
