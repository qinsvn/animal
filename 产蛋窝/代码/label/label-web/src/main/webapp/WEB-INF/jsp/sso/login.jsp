...
<div class="loadershade">
  ...
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xl">
          <img src="${basePath}/resources/images/web/logo.png"  style="width: 13%;">
        <a href="javascript:void(0)" class="navbar-brand text-lt">
            <span class="hidden-nav-xs m-l-sm">广州农标自动化科技有限公司</span>
          </a>
  ...
  <footer id="footer">
    <div class="text-center padder">
      <p>
        <small>农标科技版权所有<br>&copy;2019 <!-- 这里记得改一下  Inc.--> All Rights Reserved</small>
      </p>
    </div>
  </footer>
