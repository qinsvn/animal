...
<html lang="en" class="app">
	...
	<head>
		...
		<link rel="stylesheet" href="${basePath}/resources/css/web/Style_nest20.css" type="text/css" />
...
<!-- 									<label>购买时间 ：</label> -->
<!-- 									<input id="stime" class="input-sm  form-control input-inline" autocomplete="off" value="" type="text" style=" font-size: 14px;"> -->
<!-- 									<span class="input-inline-span">-</span> -->
<!-- 									<input id="etime" class="input-sm  form-control input-inline" autocomplete="off" value="" type="text" style=" font-size: 14px;"> -->
							</div>
						</div>
						<div class="row m-l m-b">
							<div class=" m-b-xs">
								...
								<shiro:hasPermission name="label:nestData20:export">
		...
		<script src="${basePath}/resources/js/web/nestData/p_list_nestData20.js"></script>
