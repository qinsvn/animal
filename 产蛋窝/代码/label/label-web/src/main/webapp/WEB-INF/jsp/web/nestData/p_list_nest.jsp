...
<html lang="en" class="app">
	...
	<body style="overflow-y: auto;">
					...
					<section class="panel panel-default">
						...
						<div class="row m-l m-b m-t">
							...
							<div class="form-group">
								...
								<label>最近抱窝 ：</label>
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="startNestDuration" type="text" class="input-sm  form-control input-inline" placeholder="小时">
								</div>
								<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;到  ：</label>
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="endNestDuration" type="text" class="input-sm  form-control input-inline" placeholder="小时">
								</div>
							...
							<div class="form-group">
								...
								<label>累计抱窝 ：</label>
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="startNestDurationSum" type="text" class="input-sm  form-control input-inline" placeholder="小时">
								</div>
								<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;到  ：</label>
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="endNestDurationSum" type="text" class="input-sm  form-control input-inline" placeholder="小时">
								</div>
		...
		<script src="${basePath}/resources/js/web/nestData/p_list_nest.js"></script>
