...
!function (e, t, i, n) {
    ...
    e.DtPicker = e.Class.extend({
        init: function (n) {
            ...
            var a = e.endDate;
            a instanceof Date && !isNaN(a.valueOf()) && (e.endYear = a.getFullYear(), e.endMonth = a.getMonth() + 1, e.endDay = a.getDate(), e.endHours = a.getHours(), e.endMinutes = a.getMinutes()), e.beginYear = e.beginYear || i.getFullYear() - 100, e.endYear = e.endYear || i.getFullYear() + 100;
            var r = t.ui;
