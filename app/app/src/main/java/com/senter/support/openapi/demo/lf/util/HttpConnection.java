package com.senter.support.openapi.demo.lf.util;
...
public class HttpConnection {
     ...
     * @param map
     */
    public static void http(final String url, final HttpMethod method,
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    System.out.println("Result status:"  + ((HttpURLConnection) uc).getResponseCode());
                    if (((HttpURLConnection) uc).getResponseCode() == 200) {
                        ...
                        System.out.println("Result:"  + ((HttpURLConnection) uc).getResponseCode());
                    }
