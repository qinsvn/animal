					...
					<section class="panel panel-default">
						...
						<div class="row m-l m-b">
							<div class=" m-b-xs">
								...
								<shiro:hasPermission name="c:immune:delete">
									<button class="btn btn-sm btn-info" id="deleteDeviceButt">删除免疫记录</button>
								</shiro:hasPermission>
								
								<shiro:hasPermission name="c:immune:export">
...
<!--  编辑 -->
	<div class="modal fade in" id="edit_win">
	                        ...
	                        <div class="panel-body">
	                            <form class="bs-example form-horizontal" autocomplete="off">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_name" id="edit_chikenType" disabled >
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label ">日龄</label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_name" id="edit_age"  >
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label ">免疫药物</label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_name" id="edit_immuneType"  >
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label ">免疫结果</label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_name" id="edit_result" >
	                                    </div>
	                                </div>
	                                <div class="form-group" style="margin-bottom: 0">
	                                    <div class="col-sm-4 col-sm-offset-2">
	                                        <a id="edit_cancel" class="btn btn-default">取&nbsp;&nbsp;&nbsp;&nbsp;消</a>
											<shiro:hasPermission name="c:immune:update">
		...
		<script src="${basePath}/resources/js/web/immuneData/p_list_immuneData.js"></script>
