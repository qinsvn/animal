...
<input id="basePath" value="${basePath}" type="hidden">
    ...
    <div class="col-lg-12" style="padding: 0">
        <!-- .breadcrumb -->
        <ul class="breadcrumb">
            <li><a href="#"><i class="fa icon-users"></i> 基础数据</a></li>
            <li class="active">养殖户信息</li>
        </ul>
        <!-- / .breadcrumb -->
    </div>
            ...
            <section class="panel panel-default">
                ...
                <div class="row m-l m-b">
                    <div class=" m-b-xs">
	                    ...
	                    <shiro:hasPermission name="c:dpt:create">
	                    <button id="create_company" class="btn btn-sm btn-info">新增养殖户</button>
	                    </shiro:hasPermission>
	                    <shiro:hasPermission name="c:dpt:delete">
	                    <button id="del_company" class="btn btn-sm btn-info">删除养殖户</button>
	                    </shiro:hasPermission>
                    </div>
                </div>
	            ...
	            <div class="modal-body wrapper-lg">
	                <div class="row">
	                    <section class="panel panel-default" style="    margin-bottom: 40px;">
	                        <header class="panel-heading font-bold" id="headTitleEdit">新增养殖户</header>
	                        <div class="panel-body">
	                            <form class="bs-example form-horizontal" autocomplete="off">
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label ">养殖户名称<span class="red-color">*</span></label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_name" id="edit_name" placeholder="养殖户名称">
	                                        <input type="text" class="hidden" id="edit_cid">
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group">
	                                	<label class="col-sm-2 control-label">养殖户类型</label>
	                                	<div class="col-sm-10">
		                                	<select id="typeselect" class="select_type">
												<option value="1" >第三方养殖户</option>
	                                ...
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label">养殖范围</label>
	                                    <div class="col-sm-10">
	                                        <input type="text" class="form-control edit_domain" id="edit_domain" placeholder="养殖户养殖范围">
	                                    </div>
	                                </div>
	                                <div class="line line-dashed b-b line-lg pull-in"></div>
	                                <div class="form-group">
	                                ...
	                                <div class="form-group" style="margin-bottom: 0">
	                                    <div class="col-sm-4 col-sm-offset-2">
	                                        ...
	                                        <shiro:hasPermission name="c:dpt:update">
