...
import com.ts.system.dao.MenuDao;
import com.ts.system.dao.RoleMenuDao;
...
public class MenuServiceImpl implements MenuService {
	...
	private void setChidren(Long parentId,List<Long> ids){
		Map<String, Object> map = Maps.newHashMap();
		map.put("parentId", parentId);
		List<MenuDO> list =  menuMapper.list(map );
		for (MenuDO menuDO : list) {
			ids.add(menuDO.getMenuId());
			setChidren(menuDO.getMenuId(), ids);
		}
	}
...
//		
//		List<Long> ids = Lists.newArrayList(menu.getMenuId());
//		setChidren(menu.getMenuId(), ids);
