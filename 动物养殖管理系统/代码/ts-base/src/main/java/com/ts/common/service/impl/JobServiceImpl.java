...
import com.ts.common.dao.TaskDao;
import com.ts.common.domain.ScheduleJob;
import com.ts.common.domain.TaskDO;
import com.ts.common.quartz.utils.QuartzManager;
import com.ts.common.service.JobService;
import com.ts.common.utils.ScheduleJobUtils;
...
public class JobServiceImpl implements JobService {
	...
	public void changeStatus(Long jobId, String cmd) throws SchedulerException {
		...
		if (CommonConstant.STATUS_RUNNING_STOP.equals(cmd)) {
			quartzManager.deleteJob(ScheduleJobUtils.entityToData(scheduleJob));
			scheduleJob.setJobStatus(ScheduleJob.STATUS_NOT_RUNNING);
		} else {
			if (!CommonConstant.STATUS_RUNNING_START.equals(cmd)) {
			} else {
