 ...
 * @author jolley
 */
public class UtilZXingCode {
	private static final int QRCOLOR = 0xFF000000; // 默认是黑色
    private static final int BGWHITE = 0xFFFFFFFF; // 背景颜色

    public static void main(String[] args) throws WriterException {
        try {
        	String logoPathname = "/Users/chenjolley/Downloads/vTReedJjvOHnIhLmWxWkzokJQicYkjqYIpkV94SNbUFIajlBNXicV9eg";
        	String savePathname = "/Users/chenjolley/Downloads/TDC-" + new Date().getTime() + "test.png";
            getLogoQRCode("https://www.baidu.com/", null, logoPathname, savePathname);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * 生成二维码
     * @param qrUrl 二维码内容
     * @param productName 二维码介绍
     * @param logoPathname 二维码中间logo
     * @param savePathname 二维码保存路径
     * @return
     */
    public static String getLogoQRCode(String qrUrl,String productName, String logoPathname, String savePathname) {
        ...
        try {
            UtilZXingCode zp = new UtilZXingCode();
            BufferedImage bim = zp.getQR_CODEBufferedImage(content, BarcodeFormat.QR_CODE, 400, 400, zp.getDecodeHintType());
            return zp.addLogo_QRCode(bim, StringUtils.isEmpty(logoPathname) ? null : new File(logoPathname), new LogoConfig(), productName, savePathname);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName, String savePathname) {
        try {
            /** * 读取二维码图片，并构建绘图对象 */
