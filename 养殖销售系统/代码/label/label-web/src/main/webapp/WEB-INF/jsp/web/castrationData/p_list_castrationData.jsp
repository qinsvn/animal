					...
					<section class="panel panel-default">
						...
						<div class="row m-l m-b">
							<div class=" m-b-xs">
								...
								<shiro:hasPermission name="c:castration:delete">
									<button class="btn btn-sm btn-info" id="deleteDeviceButt">删除阉割记录</button>
								</shiro:hasPermission>
								
								<shiro:hasPermission name="c:castration:export">
...
<!--  编辑 -->
	<div class="modal fade in" id="edit_win">
	    <div class="modal-dialog">
	        <div class="modal-content" style="width: 700px;height: 390px;overflow: auto;">
	                    ...
	                    <section class="panel panel-default" style=" margin-bottom: 40px;">
	                        ...
	                        <div class="panel-body">
	                            <form class="bs-example form-horizontal" autocomplete="off">
	                                ...
	                                <div class="form-group">
	                                    <label class="col-sm-2 control-label ">阉割结果</label>
	                                    <div class="col-sm-10">
	                                ...
	                                <div class="form-group" style="margin-bottom: 0">
	                                    <div class="col-sm-4 col-sm-offset-2">
	                                        ...
	                                        <shiro:hasPermission name="c:castration:update">
		...
		<script src="${basePath}/resources/js/web/castrationData/p_list_castrationData.js"></script>
