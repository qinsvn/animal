...
<html lang="en" class="app">
	...
	<body class="">
					...
					<section class="panel panel-default">
						...
						<div class="row m-l m-b m-t">
							<div class="form-group">
								...
								<div class="inline width-300" style="padding-right: 37px;">
									<input id="barCode" type="text" class="input-sm form-control">
								</div>
							</div>
							<div class="form-group">
								<label>采集时间 ：</label>
						...
						<div class="row m-l m-b">
							<div class=" m-b-xs">
								...
								<shiro:hasPermission name="c:agg:delete">
									<button class="btn btn-sm btn-info" id="deleteDeviceButt">删除蛋类</button>
								</shiro:hasPermission>
							</div>
						</div>
		...
		<script src="${basePath}/resources/js/web/agg/p_list_agg.js"></script>
