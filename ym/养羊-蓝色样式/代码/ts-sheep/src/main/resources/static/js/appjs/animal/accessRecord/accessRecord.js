var prefix = top.ctx + "/animal/accessRecord"
$(function () {
    laydate.render({
        elem: '#con_startOccurrenceTime',
        type: 'datetime'
    });
    laydate.render({
        elem: '#con_endOccurrenceTime',
        type: 'datetime'
    });
    load();
});
        ...
        .bootstrapTable(
            {
                ...
                queryParams: function (params) {
                    return {
                        ...
                        direction: $('#con_direction').val(),
                        startOccurrenceTime: $('#con_startOccurrenceTime').val(),
                        endOccurrenceTime: $('#con_endOccurrenceTime').val(),
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: '方向',
                        formatter: function (value, row, index) {
                            return top.sys.dictName('access_direction', value);
                        }
                    },
                    {
...
function reset() {
    ...
    $("#con_varietyName").val('');
    $("#con_direction").val('');
    $("#con_startOccurrenceTime").val('');
    $("#con_endOccurrenceTime").val('');
    reLoad();
}
...
function exportData() {
    ...
    var params = {
        ...
        exportFileName: "进出记录表数据",
        exportSplit: "__",
        exportkeys: ['num', 'varietyName', 'direction', 'occurrenceTime'].join("__"),
        exportHeader: ['编号', '品种', '方向', '时间'].join("__")
