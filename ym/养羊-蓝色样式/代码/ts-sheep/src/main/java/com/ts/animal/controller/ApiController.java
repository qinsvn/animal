...
import com.ts.animal.service.impl.AccessRecordServiceImpl;
...
public class ApiController {
	 ...
	 */
	@ResponseBody
	@RequestMapping("/device/restart")
	public Result restartDevices() {
		Result result = Result.ok();
		logger.info("控制所有设备 start");
		UhfReader.getReaderControllor().StartMultiEPC();//控制所有设备
		logger.info("控制所有设备 end");
		return result;
	}
}
