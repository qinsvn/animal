...
import com.ts.oa.service.NotifyRecordService;
...
public class NotifyController extends BaseController {
	...
	PageUtils message() {
        ...
        query.put("isRead",CommonConstant.OA_NOTIFY_READ_NO);
	...
	String read(@PathVariable("id") Long id, Model model) {
		...
		notifyRecordDO.setIsRead(CommonConstant.OA_NOTIFY_READ_YES);
