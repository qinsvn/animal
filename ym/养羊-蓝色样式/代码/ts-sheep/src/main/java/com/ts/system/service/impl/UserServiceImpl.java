...
import com.ts.system.dao.UserRoleDao;
import com.ts.system.domain.DeptDO;
import com.ts.system.domain.UserDO;
import com.ts.system.domain.UserRoleDO;
...
//    @Cacheable(value = "user",key = "#id")
    ...
    @Override
    public Map<Long, UserDO> users() {
    	Map<Long, UserDO> ret = new HashMap<Long, UserDO>();
    	List<UserDO> list = userMapper.list(null);
    	for (UserDO userDO : list) {
    		userDO.setPassword(null);
    		ret.put(userDO.getUserId(), userDO);
		}
        return ret;
    }
    ...
    public int remove(Long userId) {
        userRoleMapper.removeByUserId(userId);
        int ret = userMapper.remove(userId);
        SystemUtil.setUsers(users());
        return ret;
    }
    ...
    public Map<String, Object> updatePersonalImg(MultipartFile file, String avatar_data, Long userId) throws Exception {
        ...
        try {
            ...
            FileUtil.uploadFile(b, TsConfig.getUploadPath(), fileName);
        } catch (Exception e) {
