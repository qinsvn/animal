...
function exportData() {
	...
	var params = {
							...
							exportFileName :"库存数据",
							exportSplit :"##",
							exportHeader :['产品编号' ,'批次' ,'种类'  , '品种'  ,'目前体重', '所在场地', '所属养殖户' , '供应商' , '生产人员' ,'生产时间'  ].join("##"),
							exportkeys :['num', 'batchNum', 'typeName',  'varietyName', 'curWeight',  'spaceName', 'deptId', 'supplierName',  'createUser', 'createTime'].join("##")
						};
